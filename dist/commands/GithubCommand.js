...
class GithubCommand {
    register(program) {
        program
            ...
            console.log(chalk_1.default.green(`Name: ${user.name}`));
            console.log(chalk_1.default.blue(`Public Repositories: ${user.public_repos}`));
            console.log(chalk_1.default.yellow(`Followers: ${user.followers}`));
        }));
    }
}
